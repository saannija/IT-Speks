        ...
        <section id="news">
            <div id="allNews">
                ...
                <div class="pagination">
                    <button class="prev" onclick="prevPageAll()"><i class="fa-solid fa-backward-step"></i></button>
                    <span id="page-number-all"></span>
                    <button class="next" onclick="nextPageAll()"><i class="fa-solid fa-forward-step"></i></button>
                </div>
            </div>
        </section>
